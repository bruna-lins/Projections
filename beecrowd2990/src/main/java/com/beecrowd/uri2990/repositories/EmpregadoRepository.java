package com.beecrowd.uri2990.repositories;
...
import com.beecrowd.uri2990.entities.Empregado;
...
public interface EmpregadoRepository extends JpaRepository<Empregado, Long> {
	...
	List<EmpregadoDeptProjection> firstSqlSearch();
	...
	@Query(nativeQuery = true, value = "SELECT empregados.cpf, empregados.enome, departamentos.dnome "
			...
			+ "ORDER BY empregados.cpf;")
	List<EmpregadoDeptProjection> secondSqlSearch();
	
	//JPQL
	@Query("SELECT new com.beecrowd.uri2990.dto.EmpregadoDeptDTO(obj.cpf, obj.enome, obj.departamento.dnome) "
			+ "FROM Empregado obj "
